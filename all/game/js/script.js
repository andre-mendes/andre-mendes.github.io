(function(){
	...
	//nave
	var defender = new Sprite(0,0,30,50,185,400);
	...
	//entradas
	var LEFT = 37, RIGHT = 39, UP = 38, DOWN = 40, ENTER = 13, SPACE = 32;

	//ações
	var mvLeft = mvRight = mvUp = mvDown = shoot = spaceIsDown = false;
	...
	function update(){
		...
		defender.y = Math.max(0,Math.min(cnv.height + 10, defender.y + defender.vy));

		//se a Defender cair na Terra -> Game Over
		if(defender.y > cnv.height){
			gameState = OVER;
		}
